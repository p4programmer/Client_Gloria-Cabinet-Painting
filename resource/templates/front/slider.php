<section class="full-height-slider">
    <div class="swiper-container full-h paralax-slider animation-3" data-mode="horizontal" data-autoplay="0" data-slides-per-view="1" data-loop="0" data-speed="1000" data-parallax="1">
        <div class="swiper-wrapper">
            ...
            <div class="parallax-bg bg" style="background-image: url(img/banner/banner1.jpg)" data-swiper-parallax="50%"></div>
            ...
            <div class="swiper-slide">
                <div class="parallax-bg layer bg" style="background-image: url(img/banner/banner3.jpg)" data-swiper-parallax="50%"></div>
                <div class="table-view mobile-rel-block">
                    <div class="table-cell">
                        <div class="container">
                            <div class="empty-lg-50 empty-md-50 empty-sm-0 empty-xs-0"></div>
                            <div class="simple-item text-center color-type-1 simple-item-style-1" data-swiper-parallax="30%" data-swiper-parallax-duration="1000">
                                ...
                                <div class="empty-sm-30 empty-xs-30"></div>
                                <div class="wrap-padding">
                                    <h1 class="sub-title">Taste of Home</h1>
                                    <div class="empty-sm-20  empty-xs-20"></div>
                                    <div class="simple-text md simple-sub-text">
                                        <p>"The nourishment of the body is food, while the nourishment of the soul is feeding others." - Ali ibn Abi Talib</p>
                                    </div>
                                </div>
                                <div class="empty-sm-45  empty-xs-45"></div>
                                <div class="button-wrap">
                                    <a href="./menu.php" class="page-button button-style-1"><span class="txt">Order Now</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="swiper-slide">
                <div class="parallax-bg layer bg" style="background-image: url(img/banner/banner1.jpg)" data-swiper-parallax="50%"></div>
                <div class="table-view mobile-rel-block">
                    <div class="table-cell">
                        <div class="container">
                            <div class="empty-lg-50 empty-md-50 empty-sm-0 empty-xs-0"></div>
