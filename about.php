...
<body>
    ...
    <section class="page">
        <div class="cover" data-image="assets/images/about1.jpg">
            <div class="cover-top">
                <div class="container">
                    <div class="row">
    ...
    <section class="section padding-bottom-160">
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-md-12 col-sm-12 align-self-center mobile-bottom-fix">
                    <div class="left-heading">
                        <h2 class="section-title dotted">Gloria Cabinet Painting</h2>
                    </div>
                    <div class="left-text">
                ...
                <div class="offset-lg-1 col-lg-6 col-md-12 col-sm-12 align-self-center"
                    ...
                    <img src="assets/images/about.jpg" class="img-fluid float-right" alt="Title">
                </div>
            </div>
        </div>
    </section>
